...
import attr
from TestAddOn._vendor.multidict import MultiDict, MultiDictProxy, MultiMapping
from TestAddOn._vendor. yarl import URL
...
if sys.version_info >= (3, 11):
    ...
    import TestAddOn._vendor.async_timeout
...
def ceil_timeout(
...
) -> TestAddOn._vendor.async_timeout.Timeout:
    if delay is None or delay <= 0:
        return TestAddOn._vendor.async_timeout.Timeout(None)
    ...
    if delay > ceil_threshold:
        when = ceil(when)
    return TestAddOn._vendor.async_timeout.Timeout_at(when)
