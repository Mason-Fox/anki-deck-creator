...
import attr
from TestAddOn._vendor.multidict import CIMultiDict
...
class WebSocketResponse(StreamResponse):
    ...
    async def close(self, *, code: int = WSCloseCode.OK, message: bytes = b"") -> bool:
        ...
        if not self._closed:
            ...
            assert reader is not None
            try:
                async with TestAddOn._vendor.async_timeout.Timeout(self._timeout):
    ...
    async def receive(self, timeout: Optional[float] = None) -> WSMessage:
        ...
        while True:
            ...
            try:
                ...
                try:
                    async with TestAddOn._vendor.async_timeout.Timeout(timeout or self._receive_timeout):
