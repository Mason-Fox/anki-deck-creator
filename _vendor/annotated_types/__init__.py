...
if sys.version_info < (3, 8):
    from TestAddOn._vendor.typing_extensions import Protocol, runtime_checkable
else:
    from typing import Protocol, runtime_checkable

if sys.version_info < (3, 9):
    from TestAddOn._vendor.typing_extensions import Annotated, Literal
else:
...
try:
    from TestAddOn._vendor.typing_extensions import DocInfo, doc  # type: ignore [attr-defined]
except ImportError:
