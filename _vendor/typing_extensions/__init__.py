...
if hasattr(typing, "LiteralString"):  # 3.11+
    ...
    def LiteralString(self, params):
        ...
        Example::
          ...
          from TestAddOn._vendor.typing_extensions import LiteralString
...
if hasattr(typing, "Never"):  # 3.11+
    ...
    def Never(self, params):
        ...
        called, or a function that never returns::
            ...
            from TestAddOn._vendor.typing_extensions import Never
    ...
    def dataclass_transform(
        ...
        **kwargs: typing.Any,
        ...
        Example:
            ...
            from TestAddOn._vendor.typing_extensions import dataclass_transform
...
if hasattr(_types, "get_original_bases"):
    ...
    def get_original_bases(cls, /):
        ...
        Examples::
            ...
            from TestAddOn._vendor.typing_extensions import NamedTuple, TypedDict
...
if hasattr(typing, "is_protocol"):
    ...
    def is_protocol(tp: type, /) -> bool:
        ...
        Example::
            ...
            >>> from TestAddOn._vendor.typing_extensions import Protocol, is_protocol
            >>> class P(Protocol):
            ...     def a(self) -> str: ...
            ...     b: int
            >>> is_protocol(P)
    ...
    def get_protocol_members(tp: type, /) -> typing.FrozenSet[str]:
        ...
        Example::
            ...
            >>> from TestAddOn._vendor.typing_extensions import Protocol, get_protocol_members
            >>> class P(Protocol):
            ...     def a(self) -> str: ...
            ...     b: int
...
if hasattr(typing, "Doc"):
    ...
    class Doc:
        ...
        Example::
            ...
            >>> from TestAddOn._vendor.typing_extensions import Annotated, Doc
