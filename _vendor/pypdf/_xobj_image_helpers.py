"""Code in here is only used byTestAddOn._vendor.pypdf.filters._xobj_to_image"""
...
if sys.version_info[:2] >= (3, 8):
    ...
    from TestAddOn._vendor.typing_extensions import Literal  # type: ignore[assignment]

if sys.version_info[:2] >= (3, 10):
    from typing import TypeAlias
else:
    from TestAddOn._vendor.typing_extensions import TypeAlias
