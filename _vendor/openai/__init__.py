...
from TestAddOn._vendor.openai.api_resources import (
    Audio,
    ChatCompletion,
    Completion,
    Customer,
...
from TestAddOn._vendor.openai.error import APIError, InvalidRequestError, OpenAIError
from TestAddOn._vendor.openai.version import VERSION
